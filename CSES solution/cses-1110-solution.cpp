// Okay so the basic one did not get the answer.
// had to produce the suffix array of str+str
// and the first sufix whose index is less then the lenght of the original string is the starting index
// had to come up with this logic because of this "aaaba"
// in normal approach "a" is the smallest suffix, but it is not the best one when rotated
// this is why to count the rotation effect, I had to multiply the string by two and then generate suffix array of the new substring(from, to);
// accepted
